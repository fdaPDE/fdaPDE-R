...
#' Plot a \code{triangulation_2_2} object
#'
#' @param x A \code{triangulation_2_2} object defining the 2-dimensional triangular mesh, as generated by [triangulate()].
#' @param boundary_markers A vector of boundary markers that could have been set by [.triangluation$mark_boundary()]. Default is \code{NULL}.
#' @param boundary_palette A vector of the same length of \code{boundary_markers} specifying the colors to every sub-boundary. Default is \code{NULL}.
